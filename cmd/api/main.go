...
func main() {
	...
	flag.Func("cors-trusted-origins", "Trusted CORS origins (space saparated)", func(val string) error {
	...
	// set version to /debug/vars handlers
	expvar.NewString("version").Set(version)

	// set info about num of goroutines
