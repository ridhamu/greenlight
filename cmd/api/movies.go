...
func (app *application) updateMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// override the input to the current movie
	if input.Title != nil {
...
func (app *application) listMoviesHandler(w http.ResponseWriter, r *http.Request) {
	...
	input.Page = app.readInt(params, "page", 1, v)
	...
	ptrListMovie, metadata, err := app.models.Movies.GetAll(input.Title, input.Genres, input.Filters)
	if err != nil {
		app.serverErrorResponse(w, r, err)
		return
	}

	err = app.writeJSON(w, http.StatusOK, envelope{"movies": ptrListMovie, "metadata": metadata}, nil)
	if err != nil {
		app.serverErrorResponse(w, r, err)
	}
}
